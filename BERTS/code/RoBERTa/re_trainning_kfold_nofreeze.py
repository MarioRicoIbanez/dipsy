...
SAVE_DIRECTORY_UNFROZEN = "./MODELS/RoBERTa_entrenado_kfold_unfrozen_last_two_layer"
...
try:
    asyncio.run(
        send_telegram_message(message=f'Comenzando a entrenar el modelo con {LAYERS_TO_UNFREEZE} capas descongeladas'))
