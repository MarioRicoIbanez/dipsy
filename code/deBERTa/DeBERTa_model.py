...
SAVE_DIRECTORY_UNFROZEN = "./MODELS/DeBERTa_entrenado_kfold_unfrozen_last_layer"
...
try:
    ...
    model = CustomDeBERTa(base_model.to(device), num_classes=len(set(df['Emotion'])))
    ...
    kfold_results, model_frozen = kfold_cross_validation(train_inputs, train_labels, train_masks, compiled_model,
                                                         device, EPOCHS_KFOLD_FROZEN, lr=LEARNING_RATE_KFOLD_FROZEN,
